...
**   embora com baixa probabilidade de ocorrência de erro.
**
**  Paulo Shirley @ UAb
**  v2008/04/10
*/
...
void *tarefa(void *arg)
{
   ...
   /* acesso directo a S, possivelmente em simultaneo com outras
      tarefas. Pode levar a condicao de disputa! (race condition) */
