...
**  Exemplo de ma' programacao que leva a condicao de disputa (race condition)
**  Alta probabilidade de ocorrência de erro!
**
**  Paulo Shirley @ UAb
**  v2008/04/10
*/
...
void *tarefa(void *arg)
{
   ...
   /* Acesso directo a S, possivelmente em simultaneo com outras tarefas.
      Pode levar a condicao de disputa! (race condition)                  */
      
   L= S;         /* codigo logicamente equivalente a S+= soma( a->x, a->n); */
   S= L+soma( a->x, a->n); /* aumenta a probabilidade de ocorrencia de erro */
